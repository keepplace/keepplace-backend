...
object Page {
  def apply[A](_iterator: Iterator[A], _page: PageParameter, _total: Long): Page[A] = new Page[A] {
  ...
  def apply[A](_items: Iterable[A], _page: PageParameter, _total: Long): Page[A] = new Page[A] {
